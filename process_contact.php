...
if (($_SERVER['REQUEST_METHOD'] ?? '') === 'POST') {
  try {
    ...
    try {
      ...
      $mailAdmin->setFrom('bayelsa@trendsplacehotelandsuites.com', "Trend's Place Hotel & Suites Website");
      $mailAdmin->addAddress('bayelsa@trendsplacehotelandsuites.com', "Trend's Place Hotel & Suites Admin");

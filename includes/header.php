    ...
    <div class="site-nav-ul-wrap text-center d-none d-lg-block">
      <ul class="site-nav-ul js-clone-nav">
        ...
        <li class="has-children <?php echo $current_page == 'rooms.php' ? 'active' : ''; ?>">
          ...
          <ul class="dropdown">
            <li><a href="rooms.php">Grand Royale Suite</a></li>
            <li><a href="rooms.php">Ambassadorial Suite</a></li>
            <li><a href="rooms.php">Business Royale</a></li>
            <li><a href="rooms.php">Executive Suite</a></li>
            <li><a href="rooms.php">Standard Room</a></li>
            <li><a href="rooms.php">Studio Suite</a></li>
          </ul>
        </li>
        ...
        <li class="<?php echo $current_page == 'booking.php' ? 'active' : ''; ?>"><a href="https://wa.me/2347017834528?text=Hello%2c%20I'd%20like%20to%20make%20a%20reservation" target="_blank">Book Now (WhatsApp)</a></li>
      </ul>
    </div>

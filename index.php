            ...
            <div class="suite-wrap overlap-image-1">
              ...
              <div class="suite-contents" data-jarallax-element="50">
                ...
                <div class="suite-excerpt">
                  <p>Our most prestigious suite offering unparalleled luxury, space, and comfort for the discerning traveler. Starting at ₦120,000 per night.</p>
                  <p><a href="rooms.html" class="readmore">Room Details</a></p>
                </div>
              </div>
            </div>
            ...
            <div class="suite-wrap overlap-image-2">
              ...
              <div class="suite-contents" data-jarallax-element="50">
                ...
                <div class="suite-excerpt pr-5">
                  <p>A perfect blend of elegance and functionality, designed to meet the needs of both business and leisure guests. Starting at ₦80,000 per night.</p>
                  <p><a href="rooms.html" class="readmore">Room Details</a></p>
                </div>
              </div>
            ...
            <div class="row custom-row-02192 align-items-stretch">
              <div class="col-md-6 col-lg-4 mb-5" data-aos="fade-up" data-aos-delay="100">
                <div class="media-29191 text-center h-100">
                  ...
                  <p>Conveniently located just a short drive from Nnamdi Azikiwe International Airport with reliable shuttle services.</p>
              ...
              <div class="col-md-6 col-lg-4 mb-5" data-aos="fade-up" data-aos-delay="100">
                <div class="media-29191 text-center h-100">
                  ...
                  <h3>Event Spaces</h3>
                  <p>Modern and well-equipped facilities for your conferences, meetings, and social gatherings.</p>
                  <p><p><a href="#" class="readmore reverse">Read More</a></p></p>
                </div>
              </div>
              <div class="col-md-6 col-lg-4 mb-5" data-aos="fade-up" data-aos-delay="200">
